...
def run_sync_simple_client(comm, host, port, framer=Framer.SOCKET):
    ...
    #    rr = client.read_coils(1, 1, slave=1)
        rr = client.read_holding_registers(address=0, count=10, slave=0)
    ...
    #decoder = BinaryPayloadDecoder.fromRegisters(rr.registers(1), Endian.BIG, wordorder=Endian.LITTLE)
